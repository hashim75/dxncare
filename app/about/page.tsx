...
const stats = [
  ...
  { label: "Organic Products", value: "100%", icon: Leaf },
  { label: "Years of Trust", value: "15+", icon: Heart },
];

export default function AboutPage() {
  // --- DYNAMIC SCHEMA GENERATION (Organization & AboutPage) ---
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Organization",
        "@id": "https://dxncare.com/#organization",
        "name": "DXN Care",
        "url": "https://dxncare.com",
        "logo": "https://cdn.prod.website-files.com/6833690dd0efea69de65146d/699a956e7c1793e16f8f9a72_logo.webp",
        "description": "Global wellness authority providing organic Ganoderma products with certified medical guidance.",
        "foundingDate": "2025",
        "contactPoint": {
          "@type": "ContactPoint",
          "telephone": "+92-333-8656601",
      ...
      {
        "@type": "AboutPage",
        "@id": "https://dxncare.com/about/#webpage",
        "url": "https://dxncare.com/about",
        "name": "About DXN Care",
        "isPartOf": { "@id": "https://dxncare.com/#website" },
        "about": { "@id": "https://dxncare.com/#organization" }
      }
    ]
  };
  ...
  return (
    <>
      {/* --- SEO METADATA & SCHEMA --- */}
      <Head>
        <title>About DXN Care | Bridging Nature & Medical Science</title>
        <meta name="description" content="DXN Care combines the ancient healing power of organic Ganoderma with modern clinical expertise. Join 10,000+ happy families achieving holistic wellness." />
        <meta name="keywords" content="DXN Care about, organic Ganoderma, holistic wellness, certified doctors DXN, natural supplements Pakistan, integrative medicine" />
        <link rel="canonical" href="https://dxncare.com/about" />
        
        {/* Open Graph / Social Media */}
        <meta property="og:title" content="About DXN Care | Global Wellness Authority" />
        <meta property="og:description" content="Discover how DXN Care bridges the gap between natural organic supplements and professional medical guidance." />
        <meta property="og:url" content="https://dxncare.com/about" />
        <meta property="og:site_name" content="DXN Care" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?q=80&w=1200&auto=format&fit=crop" />
      ...
      <main className="bg-white">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                  ...
                  <p>
                    That's why we created a platform where <strong className="text-teal-950">Medical Doctors</strong> and <strong className="text-teal-950">Wellness Experts</strong> guide your journey. We don't just sell you a bottle; we prescribe a lifestyle.
                  </p>
                </div>
        ...
        {/* 3. INTEGRATIVE MEDICINE SECTION */}

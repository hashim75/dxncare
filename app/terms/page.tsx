...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { id: "services", label: "What We Provide", icon: Package },
    { id: "payments", label: "Payments & Refunds", icon: CreditCard },
    { id: "medical", label: "Medical Notice", icon: AlertTriangle },
    { id: "responsibilities", label: "Your Responsibilities", icon: Gavel },
    { id: "liability", label: "Our Liability", icon: Scale },
  ];
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          ...
          <div className="flex-1 bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 p-8 md:p-16">
            <article className="prose prose-lg max-w-none text-black prose-p:text-black prose-headings:text-black leading-relaxed">
              ...
              <div id="eligibility" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Eligibility to Use Our Services</h2>
                </div>
                <p>
              ...
              <div id="services" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-bold m-0 font-jakarta">What We Provide</h2>
                </div>
                
                <div className="space-y-8 mt-6">
                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <h3 className="text-xl font-bold mt-0 mb-3 text-teal-900">DXN Product Sales</h3>
                    ...
                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <h3 className="text-xl font-bold mt-0 mb-3 text-teal-900">Online Doctor Consultations</h3>
                    ...
                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        <h3 className="text-xl font-bold mt-0 mb-3 text-teal-900">Intellectual Property and Site Content</h3>
              ...
              {/* SECTION 3: PAYMENTS */}
              <div id="payments" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Payments and Our Refund Policy</h2>
                </div>
                <p>
              ...
              <div id="medical" className="scroll-mt-40 mb-20">
                <div className="bg-red-600 text-white p-10 rounded-[2rem] shadow-xl shadow-red-900/20 relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                            <AlertTriangle className="text-white" size={32} />
                            <h2 className="text-3xl font-bold m-0 text-white font-jakarta">Important Medical Notice</h2>
                        </div>
                        ...
                        <p className="text-white/90 text-lg font-medium leading-relaxed mt-4">
              ...
              <div id="responsibilities" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Your Responsibilities</h2>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    {[
                        ...
                        <div key={idx} className="bg-slate-50 border border-slate-100 p-5 rounded-2xl">
                            <h4 className="font-bold text-black text-sm uppercase tracking-wide mb-2 flex items-center gap-2">
              ...
              {/* SECTION 6: LIABILITY */}
              <div id="liability" className="scroll-mt-40">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold border border-slate-200 shadow-sm">06</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Our Liability</h2>
                </div>
                <p>

...
import { 
  ...
  UserCheck, ShieldCheck, FileText 
} from "lucide-react";
...
export default function PrivacyPage() {
  ...
  return (
    <main className="bg-slate-50 min-h-screen pb-32">
      ...
      {/* 1. HEADER SECTION */}
      <section className="relative bg-teal-950 pt-40 pb-32 overflow-hidden">
        {/* Abstract Background Shapes */}
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-b from-teal-800 to-transparent rounded-full blur-[100px] opacity-30 -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-900 rounded-full blur-[80px] opacity-20 translate-y-1/3 -translate-x-1/4 pointer-events-none"></div>
        ...
        <motion.div 
          ...
          className="absolute right-[15%] top-1/3 text-white/5 hidden lg:block"
        >
          <ShieldCheck size={350} strokeWidth={1} />
        </motion.div>

        <div className="container mx-auto px-4 relative z-10 text-center">
            <Link href="/" className="inline-flex items-center gap-2 text-teal-200 hover:text-white transition-colors mb-8 font-medium group">
              <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
              Back to Home
            </Link>
            <h1 className="text-5xl md:text-7xl font-bold font-jakarta text-white mb-6 tracking-tight">
      ...
      <section className="container mx-auto px-4 -mt-20 relative z-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          ...
          {/* === LEFT COLUMN: CONTENT === */}
          <div className="flex-1 bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 p-8 md:p-16">
            <article className="prose prose-lg max-w-none text-black prose-p:text-black prose-headings:text-black leading-relaxed">
              ...
              <div id="collection" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-teal-100 text-teal-800 flex items-center justify-center font-bold border border-teal-200 shadow-sm">01</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Information Collection</h2>
                </div>
                <p>
                ...
                <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 mt-6">
                    <h4 className="flex items-center gap-2 text-lg font-bold mt-0 text-teal-900"><Eye className="text-teal-600" size={20}/> Usage and Analytics Data</h4>
              ...
              {/* SECTION 2: USAGE */}
              <div id="usage" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold border border-slate-200 shadow-sm">02</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">How We Use Your Information</h2>
                </div>
                ...
                <p className="mt-6 text-sm italic text-slate-500 border-l-4 border-slate-200 pl-4">
              ...
              {/* SECTION 3: SECURITY */}
              <div id="security" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold border border-slate-200 shadow-sm">03</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Data Storage and Security</h2>
                </div>
                <div className="bg-teal-50 border border-teal-100 p-8 rounded-[2rem]">
                    <div className="flex items-start gap-4">
                        <Lock className="text-teal-700 mt-1 shrink-0" size={24} />
                        <p className="m-0 text-teal-900 font-medium leading-relaxed">
              ...
              {/* SECTION 4: COOKIES */}
              <div id="cookies" className="scroll-mt-40 mb-20">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold border border-slate-200 shadow-sm">04</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Cookies and Google Analytics</h2>
                </div>
                <p>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-6">
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <h4 className="font-bold text-black mt-0 mb-2">Essential Cookies</h4>
                        <p className="text-sm m-0">Some cookies are necessary for the basic functions of our site, such as maintaining your login session. If you disable these, the site may not function properly for you.</p>
                    </div>
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                        <h4 className="font-bold text-black mt-0 mb-2">Analytics Cookies</h4>
                        <p className="text-sm m-0">We use Google Analytics cookies to understand how users interact with our site. These cookies collect anonymous information. We use this data solely to identify trends and improve our content.</p>
                    </div>
                </div>
              </div>
              ...
              <div id="rights" className="scroll-mt-40">
                <div className="flex items-center gap-4 mb-6">
                    <span className="w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold border border-slate-200 shadow-sm">05</span>
                    <h2 className="text-3xl font-bold m-0 font-jakarta">Your Privacy Rights</h2>
                </div>
                <p className="mb-4">Depending on where you live, you have certain rights over your personal data:</p>
                
                <ul className="space-y-2 marker:text-teal-600 font-medium list-disc pl-5 mb-8">
                ...
                <div className="mt-8 pt-8 border-t border-slate-200">
                    <p className="font-bold mb-2">To use any of these rights, please get in touch using the form given below.</p>
                    ...
                    <Link href="/contact" className="inline-block mt-4 bg-teal-900 text-white px-6 py-3 rounded-xl font-bold hover:bg-teal-800 transition-colors">
                        Contact Us
                    </Link>
                </div>
              </div>
